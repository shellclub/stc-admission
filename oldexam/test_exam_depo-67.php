<?php 
 ...
 $sql = "select * from tb_user where id ='".$ids1."'";
...
<div id="section1" class="container-fluid">
 ...
 <?php if($log_data==0) include("rand_test_depo.php"); ?>  
<?php for($a=0;$a<4;$a++) { ?>
...
var tx_score="";
var numt=0;
for(var a=1;a<41;a++) totalExamArray[a]=0;
var data;
 var chk=0;
 var hour  =0;
 var minute =0;
...
function radio_check(examDone) {
        ...
        if(totalExam==40){
            ...
            document.getElementById("numtest").innerHTML = "คุณทำข้อสอบครบ 40 ข้อ";
            tx_scroe ="ทำข้อสอบครบ 40 ข้อ";
        }
        else {
...
function alertS(){
  const swalWithBootstrapButtons = Swal.mixin({
        ...
        swalWithBootstrapButtons.fire({
              ...
              text: "คุณทำข้อสอบไป "+numt+" ข้อ จาก 40 ข้อ  ต้องการส่งคำตอบ กด ตกลงส่งคำตอบ  ถ้าต้องการยกเลิกกดปุ่ม กลับไปทำข้อสอบ  ข้อสอบที่ยังไม่ได้ทำคือ ข้อ : \n "+missedExam+" \n",
              icon: "warning",
              showCancelButton: true,
              confirmButtonText: "ตกลงส่งคำตอบ",
       ...
       $.ajax({
        ...
        for(var x=1;x<101;x++){
            if(totalExamArray[x]==0) {
				 missedExam = missedExam+"ข้อ "+x+",\t";
				if (x%10==0)  missedExam = missedExam+"\n";
		     }
        }  
       var answer = confirm("คุณทำข้อสอบไป "+numt+" ข้อ ยังไม่ครบ 100 ข้อ  ข้อสอบที่ยังไม่ได้ทำคือ \n "+missedExam+" \n ต้องการส่งคำตอบ กด ปุ่ม OK ถ้าต้องการ ยกเลิกกดปุ่ม Cancel");
        missedExam ="";
        if (answer) {
            return true;
            document.form1.submit();
   ...
   // ping();
    ...
    var xmlhttp = new XMLHttpRequest();       
      xmlhttp.onreadystatechange = function() {
        ...
        //ping();       if()
                        if(minute >= 50) document.form1.submit();
                        else{
                            if(numt==40) document.form1.submit() ; 
                            else {
                              alertS();
                            }
                          // answer = confirm("คุณทำข้อสอบไป "+numt+" ข้อ ยังไม่ครบ 40 ข้อ  ข้อสอบที่ยังไม่ได้ทำคือ \n "+missedExam+" \n ต้องการส่งคำตอบ กด ปุ่ม OK ถ้าต้องการ ยกเลิกกดปุ่ม Cancel");
                           //else answer = true;
                        }
    ...
    if(data==1){
     ...
     if(numt < 100) {
        ...
        //ping();
       //document.getElementById("myBtn").innerHTML = "ส่งผลคำตอบ"+answer;
       //var answer = confirm("คุณทำข้อสอบไป "+numt+" ข้อ ยังไม่ครบ 40 ข้อ  ข้อสอบที่ยังไม่ได้ทำคือ \n "+missedExam+" \n ต้องการส่งคำตอบ กด ปุ่ม OK ถ้าต้องการ ยกเลิกกดปุ่ม Cancel");
        missedExam ="";
        /*
        if (answer) {
            return true;
...
function countTimer() {
   ...
   if(hour >= 1) {
    ...
    if(numt==40) 
        document.getElementById("myBtn").innerHTML = "ทำข้อสอบครบ 40 ข้อ";
    else{
        if(chk==1) 
