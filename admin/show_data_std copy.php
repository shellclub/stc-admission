...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ข้อมูลผู้ลงทะเบียน
        <small>ข้อมูลผู้ลงทะเบียนสอบ </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="home_menu.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">ข้อมูลผู้ลงทะเบียนสอบ</a></li>
        ...
        <div class="row">
         ...
         <div class="box">
            <div class="box-header">
              <h3 class="box-title">ข้อมูลผู้ลงทะเบียนสอบ</h3>
            </div>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <?php 
                    $i=1;
                    $sql = "select * from tb_user_new  where level = '1' order by de_id  ";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="edit_data_std.php" method="post" enctype="multipart/form">
