...
/**
 * ==============================================================================
 * Function: Export Student Data (Level Filtered)
 * Description: ส่งออกข้อมูลผู้สมัครแยกตามระดับชั้น (ทั้งหมด, ปวช., ปวส., ป.ตรี)
...
if ($level_filter == 1) $filename_suffix = "ปวช"; // ปวช.
elseif ($level_filter == 2) $filename_suffix = "ปวส"; // ปวส. (รวม 2,3)
elseif ($level_filter == 4) $filename_suffix = "ป.ตรี"; // ป.ตรี
...
<body>
    <table x:str border="1">
        <thead>
            <tr>
                <th colspan="8" style="font-size: 16px; font-weight: bold; height: 40px; vertical-align: middle;">
            ...
            <tr>
                ...
                <th class="header-bg" style="width: 150px;">รหัสบัตรประชาชน</th>
        ...
        <tbody>
            ...
            if ($level_filter == 0) {
                ...
                // ปวส. (รองรับทั้ง level 2 และ 3 ตามโครงสร้างเดิมของคุณ)
            ...
            <tr>
                ...
                <td x:str class="text-center"><?php echo $row['idcard']; ?></td>
            ...
            <?php 
                ...
                echo "<tr><td colspan='8' class='text-center'>ไม่มีข้อมูลในระดับที่เลือก</td></tr>";
            }
            ?>
        </tbody>
    </table>
