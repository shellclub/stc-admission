...
<head>
   <meta charset="utf-8">
    ...
    <title>เข้าสู่ระบบ ทดสอบวัดความรู้ </title>
  <!-- Bootstrap 3.3.7 -->
                ...
                <?php for($i=0;$i<10;$i++){    ?>
                     <!-- div head -->
                            <div class="box box-danger">
                                <div class="box-header with-border">
                                    <h3 class="text-primary">ข้อที่ <?php echo  $id_s[$i]; ?> / <?php echo $i+1; ?>:</h3>                                     
                                        <?php if($img_q[$i]!=''){ ?>  
                                         ...
                                         <div class="col-sm-6">
                                             <label >
                                                    ...
                                                    <img  src="ImagesQuestions/<?php echo $choice1_img[$i];  ?>" />
                                                     <p class="lead">  <?php echo $choice1[$i]; ?> </p>  
                                             </lable>
                                        </div>   
                                        <div class="col-sm-6"> 
                                             <label >
                                                    ...
                                                    <img  src="ImagesQuestions/<?php echo $choice2_img[$i];  ?>" />
                                                     <p class="lead">  <?php echo $choice2[$i]; ?> </p> 
                                             </lable> 
                                        </div>  
                                    </div>
                                    <div class="col-md-12">  
                                        <div class="col-sm-6"> 
                                             <label >
                                                    ...
                                                    <p class="lead">  <?php echo $choice3[$i]; ?> </p>  
                                            </label>
                                        </div> 
                                        <div class="col-sm-6"> 
                                              <label > 
                                                    ...
                                                    <img  src="ImagesQuestions/<?php echo $choice4_img[$i];  ?>" />
                                                     <p class="lead">  <?php echo $choice4[$i]; ?> </p>  
                                              </label>
                                              <label> 
                                                <p><?php echo $ans[$i]; ?> </p>
                                              </label>
